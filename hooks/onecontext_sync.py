#!/usr/bin/env python3
"""Claude PostToolUse hook that mirrors tool output into OneContext."""
...
from hook_common import (
    ...
    load_onecontext as _load_onecontext,
...
def main() -> int:
    ensure_project_store, ensure_global_store, Event = _load_onecontext()
    if Event is None:
        return 0
    ...
    agent_name = os.environ.get("ONECONTEXT_AGENT", "claude")
